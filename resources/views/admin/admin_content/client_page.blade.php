			...
			<strong style="color:red; margin-left:20px;font-size:15px !important;">
                ...
                ?>
                          ...
                          <div class="panel-body">
                             {!! Form::open(['url' => 'save-client','method'=>'post', 'enctype'=>'multipart/form-data', 'class' => 'form-horizontal tasi-form']) !!} 
                                  
                                  <div class="form-group">
                                      <label for="exampleInputPassword1">Client Title</label>
                                      <input type="text" name="client_title" class="form-control" id="exampleInputPassword1" placeholder="Client Title">
                                  </div>
