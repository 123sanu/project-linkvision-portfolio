                      ...
                      <div class="adv-table editable-table ">
                        <!--  <div class="clearfix">
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tr class="">
                                  <td class="center">{{$v_project->project_title}}</td>
								  <td class="center">{{$v_project->project_href}}</td>
                                  <td class="center">{{$v_project->project_url}}</td>
                                  <td class="center"><img src="{{URL::to($v_project->project_img)}}" style="width:50px;height:50px;"></td>
                                  <td class="center">
								  @if($v_project->project_status==1)
