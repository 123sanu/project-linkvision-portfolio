                      ...
                      <div class="adv-table editable-table ">
                        <!--  <div class="clearfix">
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
                              ...
                              <tr class="">
                                  <td class="center">{{$v_client->client_title}}</td>
                                  
                                  <td class="center"><img src="{{URL::to($v_client->client_img)}}" style="width:50px;height:50px;"></td>
                                  <td class="center">
