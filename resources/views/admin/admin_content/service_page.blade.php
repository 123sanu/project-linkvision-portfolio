			...
			<strong style="color:red; margin-left:20px;font-size:15px !important">
                ...
                ?>
                          ...
                          <div class="panel-body">
                             {!! Form::open(['url' => 'save-service','method'=>'post', 'enctype'=>'multipart/form-data', 'class' => 'form-horizontal tasi-form']) !!} 
                                  
                                  <div class="form-group">
                                      <label for="exampleInputPassword1">Service Title</label>
                                      <input type="text" name="service_title" class="form-control" id="exampleInputPassword1" placeholder="Service Title">
                                  </div>
