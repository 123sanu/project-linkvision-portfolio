			...
			<strong style="color:red; margin-left:20px;font-size:15px !important;">
                ...
                ?>
                          ...
                          <div class="panel-body">
                             {!! Form::open(['url' => 'save-project','method'=>'post', 'enctype'=>'multipart/form-data', 'class' => 'form-horizontal tasi-form']) !!} 
                                  
                                  <div class="form-group">
                                      <label for="exampleInputPassword1">Project Title</label>
                                      <input type="text" name="project_title" class="form-control" id="exampleInputPassword1" placeholder="Project Title">
                                  </div>
								  <div class="form-group">
                                      <label for="exampleInputPassword1">Project HREF</label>
                                      <input type="text" name="project_href" class="form-control" id="exampleInputPassword1" placeholder="Project HREF">
                                  </div>
								 <div class="form-group">
                                      <label for="exampleInputPassword1">Project URL</label>
                                      <input type="text" name="project_url" class="form-control" id="exampleInputPassword1" placeholder="Project URL">
                                  </div>
