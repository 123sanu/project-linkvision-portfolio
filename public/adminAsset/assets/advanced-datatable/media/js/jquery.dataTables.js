...
(/** @lends <global> */function( $ ) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFilterComplete ( oSettings, oInput, iForce )
		{
			...
			{
				/* Global filter */
				_fnFilter( oSettings, oInput.sSearch, iForce,sTableId == this.id )
				{
	...
	DataTable.defaults = {
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *   oInput.bRegex, oInput.bSmart, oInput.bCaseInsensitive );
				fnSaveFilter( oInput );
		...
		this.each(function() {
			...
			for ( i=0, iLen=DataTable.settings.length ; i<iLen ; i++ )
			{
				 ...
				 */
				if ( DataTable.settings[i].      "bSortCellsTop": true
		 *      } );
		 *    } );
		 */
		"bSortCellsTop": false,
